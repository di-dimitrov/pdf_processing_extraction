...
BBOX_THICKNESS = 25
PATH_IMGS = r'00_Data/Prepared Data/images'
PATH_BBOX = r'00_Data/Prepared Data/bounding_boxes'
CLASS_LIST = ['text_q', 'image_text_q']
...
parser.add_argument('--images_path', default=PATH_IMGS, type=str, help="path to the images directory")
parser.add_argument('--bbox_path', default=PATH_BBOX, type=str, help="path to bounding box directory")
...
img = None
img_objects = []
bb_dir = args.bbox_path

if not os.path.exists(bb_dir):
    os.makedirs(bb_dir)
    # print(f"Bounding Box directory '{bb_dir}' created successfully.")
else:
    pass
    # print(f"Bounding Box directory '{bb_dir}' already exists.")
...
def get_txt_path(img_path):
    ...
    return bb_dir + fr"/{img_name.replace(img_type, 'txt')}"
...
for img_path in image_list:
    txt_path = get_txt_path(img_path)
    # print("this file is created", txt_path)
